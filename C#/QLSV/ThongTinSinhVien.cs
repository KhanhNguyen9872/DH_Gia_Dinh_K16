...
namespace LTTQBuoi6_QLSV
{
    public partial class ThongTinSinhVien : Form
    {
        ...
        private void btnThem_Click(object sender, EventArgs e)
        {
            ...
            string qr = "insert into SinhVien values (N'"+hoten+"',N'"+gioitinh+"','"+sdt+"',N'"+malop+"')";
        ...
        private void dataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            ...
            txtMaLop.Text = dataGridView1.Rows[index].Cells[4].Value.ToString();
        }

        private void btnXoa_Click(object sender, EventArgs e)
        {
            int masv = Convert.ToInt32(txtID.Text);
        ...
        private void btnSua_Click(object sender, EventArgs e)
        {
            ...
            string qr = "UPDATE SinhVien SET TenSV=N'"+hoten+"',Phai=N'"+gioitinh+"',SDT='"+sdt+"',MaLop=N'"+ malop + "' WHERE MaSV =" + id;
            ketnoi.ExecuteNonQuery(qr);
            loaddata();
        ...
        private void btnTimkiem_Click(object sender, EventArgs e)
        {
            if (rbTimID.Checked)
            {
                ...
                string query = "select * from SinhVien where MaSV = " + giatriID;
            ...
            else if (rbTimSDT.Checked)
            {
                ...
                string query = "select * from SinhVien where MaSV =N'" + name + "'";
                DataTable dt = ketnoi.Execute(query);
